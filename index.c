...
/*   Updated: 2022/10/08 02:44:50 by sciftci          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int get_target_index(t_stack **stack_a, int b_order, int target_order, int target_index)
{
    t_stack *tmp_a;
    int last_index;
...
void assign_target_index(t_stack **stack_a, t_stack **stack_b)
{
    ...
    while (tmp_b)
    {
        target_index = get_target_index(stack_a, tmp_b->index, INT_MAX, target_index);
